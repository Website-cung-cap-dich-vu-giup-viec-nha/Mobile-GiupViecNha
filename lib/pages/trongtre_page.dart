...
class TrongTrePage extends StatefulWidget {
  const TrongTrePage({super.key, required this.idDiaChi});

  final String idDiaChi;

  @override
  State<TrongTrePage> createState() => _TrongTrePageState();
}

class _TrongTrePageState extends State<TrongTrePage> {
    ...
    if (idChiTietDV != null) {
      ...
      if (selectedService != null) {
        setState(() {
          ...
          if (soTre >= 2) {
            tongTien += (0.3 * tongTien * (soTre - 1)).ceil();
          }
        });
      }
    }
      ...
      try {
        final response = await http.post(
          ...
          body: jsonEncode(<String, String>{
            ...
            'SoNguoiDuocChamSoc': soTre.toString(),
            'GioBatDau': gioPhut,
            'GhiChu': ghiChu,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            keyboardType: TextInputType.number,
                            initialValue: soTre.toString(),
                            onChanged: (value) {
                              setState(() {
                                soTre = int.tryParse(value) ?? soTre;
                                calculateTongTien();
                              });
                            },
                            validator: (value) {
